...
Source0  : http://ftp.gnome.org/pub/GNOME/sources/libgsf/1.14/libgsf-1.14.46.tar.xz
...
%prep
%setup -q -n libgsf-1.14.46
cd %{_builddir}/libgsf-1.14.46
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580939549
...
cp %{_builddir}/libgsf-1.14.46/COPYING %{buildroot}/usr/share/package-licenses/libgsf/217bce14cea37348f2a0182adf35c02137ed9a01
cp %{_builddir}/libgsf-1.14.46/COPYING.LIB %{buildroot}/usr/share/package-licenses/libgsf/9a8724b113a48b8654879231e204c01029e94f92
%make_install
%find_lang libgsf
...
/usr/share/gtk-doc/html/gsf/gsf-utils.html
...
/usr/lib64/libgsf-1.so.114.0.46
