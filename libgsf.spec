...
Source0  : https://download.gnome.org/sources/libgsf/1.14/libgsf-1.14.51.tar.xz
...
%prep
%setup -q -n libgsf-1.14.51
cd %{_builddir}/libgsf-1.14.51
pushd ..
cp -a libgsf-1.14.51 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699554524
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgsf-1.so.114.0.51
/usr/lib64/libgsf-1.so.114
/usr/lib64/libgsf-1.so.114.0.51
