...
Source0  : https://download.gnome.org/sources/libgsf/1.14/libgsf-1.14.52.tar.xz
...
%prep
%setup -q -n libgsf-1.14.52
cd %{_builddir}/libgsf-1.14.52
pushd ..
cp -a libgsf-1.14.52 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707241032
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgsf-1.so.114.0.52
/usr/lib64/libgsf-1.so.114
/usr/lib64/libgsf-1.so.114.0.52
