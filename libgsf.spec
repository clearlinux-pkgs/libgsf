...
Source0  : https://download.gnome.org/sources/libgsf/1.14/libgsf-1.14.53.tar.xz
...
%prep
%setup -q -n libgsf-1.14.53
cd %{_builddir}/libgsf-1.14.53
pushd ..
cp -a libgsf-1.14.53 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727795329
...
cp %{_builddir}/libgsf-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libgsf/9a8724b113a48b8654879231e204c01029e94f92 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%defattr(-,root,root,-)
/V3/usr/bin/gsf
/V3/usr/bin/gsf-office-thumbnailer
/V3/usr/bin/gsf-vba-dump
/usr/bin/gsf
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgsf-1.so.114.0.53
/usr/lib64/libgsf-1.so.114
/usr/lib64/libgsf-1.so.114.0.53
